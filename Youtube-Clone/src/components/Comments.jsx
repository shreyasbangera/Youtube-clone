              ...
              <div className="font-semibold flex items-start pt-2">
                ...
                <div className="flex flex-col ml-3 gap-1">
                  ...
                  <p className="font-normal">
                    {ReactHtmlParser(topLevelComment.snippet.textDisplay)}
                  </p>
                  <div className="flex gap-4 mt-2 items-center">
                    <button className="flex font-normal text-sm items-center gap-2">
                      <BiLike size={20} />
                      {kFormatter(topLevelComment.snippet.likeCount)}
                    </button>
                    <button>
                      <BiDislike size={20} />
                    </button>
